        ...
        <div
            ...
            <div className="w-full lg:w-3/4 p-10 text-colors-text-plain">
                ...
                <p className="mt-4 mr-20  text-base lg:text-lg">
                   Connect with us today to discover your dream job or hire the top talent that drives your business forward. Whether you&apos;re looking for the next step in your career or the perfect candidate to grow your team, we&apos;re here to help you succeed!
                </p>
            </div>
